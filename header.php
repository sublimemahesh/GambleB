        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                <div class="single-header-top">
                    <p>
                        <span>Welcome to GambleB!</span>
                        <span><i class="fa fa-phone"></i> (+94) 11-111-1111</span>
                    </p>
                </div>
            </div>
...
<header class="header-area blue-bg-2">
    <nav class="navbar navbar-expand-lg main-menu">
        <div class="container">
            ...
            <a class="navbar-brand" href="./"><img src="images/logo/logo-small.png" class="d-inline-block align-top" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="header-btn justify-content-end">
                    <button type="button" class="bttn-small btn-blu">Play now</button>
                </div>
            </div>
        </div>
    </nav>

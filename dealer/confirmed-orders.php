    ...
    <body class="theme-2">
        ...
        <div class="container">
            <div class="header-bar">
                <i class="fa fa-map-marker"></i> : Confirmed Orders
            </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover data_table dataTable" style="width: 100%">
                            ...
                            <tbody>
                                <?php
                                foreach (Order::getDealerConfirmedOrders($DEALER->id) as $key => $order) {
                                    ...
                                    <tr id="row_<?php echo $order['id']; ?>" >
                                        ...
                                        <td>  
                                            ...
                                            <a href="#" id="complete-order" data-id="<?php echo $order['id']; ?>" title="Complete Order"> <button class="fa fa-check delete-btn"></button></a>
                                        </td>
                                    </tr>
                                    <?php
                                }

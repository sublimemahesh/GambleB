                                ...
                                <div>
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $orders = Order::getOrdersByDeliveryStatusDescending($status);
                                            if (count($orders) > 0) {
                                                foreach ($orders as $key => $order) {
                                                    ...
                                                    <tr id="row_<?php echo $order['id']; ?>">
                                                        ...
                                                        <?php
                                                        if (($order['payment_status_code']) == 2) {
                                                            echo '<td class="text-right" style="color: #3b9d4a;font-weight: 700;">Success</td>';
                                                        } else {
                                                            echo '<td class="text-right" style="color: #bf3e3e;font-weight: 700;">Failed</td>';
                                                        }
                                                        ?>

                                            ...
                                            if (count($orders) > 0) {
                                                foreach ($orders as $key => $order) {
                                                    ...
                                                    <tr id="row_<?php echo $order['id']; ?>">
                                                        ...
                                                        <?php
                                                        if ($order['status'] == 0) {
                                                            echo '<td style="color: red; font-weight:600;">Canceled</td>';
                                                        } elseif ($order['delivery_status'] == 0) {
                                                            echo '<td style="color: black; font-weight:600;">Pending</td>';
                                                        } elseif ($order['delivery_status'] == 1) {
                                                            echo '<td style="color: green; font-weight:600;">Confirmed</td>';
                                                        } elseif ($order['delivery_status'] == 2) {
                                                            echo '<td style="color: blue; font-weight:600;">Delivered</td>';
                                                        }
                                                        ?>
                                                        </td>

...
class City {
    ...
    public function GetDealerCitiesByDistrict($district) {

        $query = "SELECT * FROM `city` WHERE `district` = '" . $district . "' AND `id` IN (SELECT distinct(`city`) FROM `dealer_area`) ORDER BY `name` ASC";

...
<!--        <div id="preloader">
        ...
        <div class="container">
            <div class="header-bar">
                <i class="fa fa-map-marker"></i> : Manage Groups
            </div>
                                ...
                                foreach ($GROUP->getGroupsByMember($MEMBER->id) as $key => $group) {
                                    ...
                                    <tr id="row_<?php echo $group['id']; ?>" >
                                        ...
                                        <td class="text-center">    
                                            <a href="edit-group.php?id=<?php echo $group['id']; ?>" class="edit-area btn btn-sm btn-info" data-id="<?php echo $group['id']; ?>"> <i class="fa fa-pencil"></i></a> | 
                                            <div href="#"  class="delete-group btn btn-sm btn-danger" data-id="<?php echo $group['id']; ?>"> <i class="fa fa-trash"></i></div>
                                        </td>
                                    </tr>
                                    <?php
                                }
